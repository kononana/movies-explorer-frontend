...
const Register = ({ onRegisterSubmit, isPopupOpened, onClosePopup, isSuccsesful }) => {
    ...
    return (
        <>
            <SignForm onSubmit={onSubmit} titleText='Добро пожаловать!' buttonText='Зарегистрироваться' spanText='Уже зарегистрированы?' linkText='Войти' linkTo='/signin' reallyValid={reallyValid} >
